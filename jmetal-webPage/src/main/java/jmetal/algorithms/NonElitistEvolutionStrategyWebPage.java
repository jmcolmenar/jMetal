...
public class NonElitistEvolutionStrategyWebPage<S extends Solution<?>> extends NonElitistEvolutionStrategy<S> {
	 ...
	 * Constructor
	 */
	public NonElitistEvolutionStrategyWebPage(ResultRepository resultRepository,WebPageExperiment experimentName,
