...
public class NonElitistEvolutionStrategyWebPageUnitTest {

	@Test
	public void NonElitistEvolutionStrategyWebPageUnitTest() {
		...
		algorithm = new NonElitistEvolutionStrategyWebPage<DoubleSolution>(null, null, problem, 1, 10, 250, mutation);
